    ...
    const getVariantThemeClass = () => {
      ...
      switch (variant) {
        case 'outline':
          return (
            styles[
              `button${themePrefix}Outline` as keyof typeof styles
            ] || ''
          )
        case 'ghost':
          return (
            styles[
              `button${themePrefix}Ghost` as keyof typeof styles
            ] || ''
          )
        case 'link':
          return (
            styles[
              `button${themePrefix}Link` as keyof typeof styles
            ] || ''
          )
        case 'secondary':
          return (
            styles[
              `button${themePrefix}Secondary` as keyof typeof styles
            ] || ''
          )
        default:
