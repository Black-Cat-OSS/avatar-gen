...
const ThemeSwitcher = () => {
  ...
  return (
    <div
      className={`mb-4 p-3 rounded-lg border ${getThemeClasses()}`}
    >
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-2'>
          {getThemeIcon()}
          <span className='text-sm font-medium'>
            Theme Switcher ({currentTheme})
          </span>
        </div>
  ...
  args: {
    ...
    children: (
      <div className='prose prose-sm max-w-none'>
        <p>
          This is a universal callout component that can
          contain any content. You can use it for warnings,
          information, technology stacks, or any other
          content.
        </p>
        <ul>
...
export const Info: Story = {
  ...
  args: {
    title: 'Information',
    subtitle:
      'This is an informational callout with dark blue styling',
    type: 'info',
    children: (
      <div className='space-y-3'>
        <p>
          This callout provides important information that
          users should be aware of. It uses a sophisticated
          dark blue color scheme for a professional
          appearance.
        </p>
        <ul className='list-disc list-inside space-y-1'>
          ...
          <li>
            Perfect for general information and
            documentation
          </li>
...
export const Error: Story = {
  args: {
    ...
    children: (
      <div className='space-y-3'>
        <p>
          This callout indicates an error that needs
          immediate attention.
        </p>
...
export const Tips: Story = {
  args: {
    ...
    children: (
      <div className='space-y-3'>
        <p>
          This callout provides helpful tips and best
          practices with cyan styling and a lightbulb icon.
        </p>
        ...
        <ul className='list-disc list-inside space-y-1 text-sm'>
          <li>
            Features a lightbulb icon for visual appeal
          </li>
          <li>Uses cyan color scheme for freshness</li>
          <li>
            Perfect for helpful advice and best practices
          </li>
        </ul>
      </div>
    ),
...
export const Success: Story = {
  args: {
    ...
    children: (
      <div className='space-y-3'>
        <p>
          This callout indicates a successful operation or
          completion with green styling.
        </p>
        <div className='p-3 bg-green-100 dark:bg-green-900 rounded border border-green-200 dark:border-green-700'>
          <p className='text-sm text-green-800 dark:text-green-200'>
            <strong>✅ Success:</strong> Your changes have
...
export const Quote: Story = {
  ...
  args: {
    title: 'Quote',
    subtitle:
      'Inspirational or notable quote with math-themed purple styling',
    type: 'quote',
    children: (
      <div className='space-y-3'>
        ...
        <div className='mt-4 p-3 bg-violet-50 dark:bg-violet-900/20 rounded border border-violet-200 dark:border-violet-700'>
          <p className='text-sm text-violet-700 dark:text-violet-300'>
            <strong>Perfect for:</strong> Inspirational
            quotes, testimonials, notable sayings, and
...
export const AllTypes: Story = {
  render: () => (
    <div className='space-y-6'>
      ...
      <Callout
        title='Information'
        subtitle='Important information for users'
        type='info'
      >
        <p>
          This callout provides informational content with
          blue styling.
        </p>
      </Callout>
      ...
      >
        <p>
          This callout indicates a warning with yellow
          styling.
        </p>
      </Callout>
      ...
      >
        <p>
          This callout indicates success with green styling.
        </p>
      </Callout>
      ...
      >
        <p>
          This callout displays quotes with purple/violet
          styling.
        </p>
      </Callout>
    </div>
...
export const DarkTheme: Story = {
  args: {
    ...
    subtitle:
      'This callout adapts to dark mode automatically with semi-transparent backgrounds',
    children: (
      <div className='space-y-3'>
        <div className='flex items-center'>
          <div className='w-3 h-3 bg-sky-600 rounded-full mr-3'></div>
          <span>
            Uses Tailwind CSS variables for theme-aware
            colors
          </span>
        </div>
        <div className='flex items-center'>
        ...
        <div className='mt-4 p-3 bg-muted rounded border'>
          <p className='text-sm text-muted-foreground'>
            The component uses CSS variables and{' '}
            <code>color-mix()</code> function for modern,
            sophisticated dark mode styling. No additional
