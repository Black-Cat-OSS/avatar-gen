    ...
    <div className='max-w-4xl mx-auto space-y-6'>
      <div className='text-center'>
        ...
        <p className='text-lg text-gray-600 dark:text-gray-300'>
          This content will be blurred when the overlay is
          active
        </p>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6'>
          ...
          <p className='text-gray-600 dark:text-gray-300'>
            This is some sample content that will be blurred
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6'>
          ...
          <p className='text-gray-600 dark:text-gray-300'>
            Another card with content that demonstrates the
            blur effect.
          </p>
        </div>
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6'>
          ...
          <p className='text-gray-600 dark:text-gray-300'>
            Third card to show the full blur effect across
            multiple elements.
          </p>
        </div>
      </div>
      ...
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8'>
        ...
        <p className='text-gray-600 dark:text-gray-300 mb-4'>
          Click the buttons below to see different overlay
          configurations:
        </p>
        ...
        <div className='flex items-center justify-center h-full'>
          <div className='bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 max-w-md mx-4 text-center'>
            ...
            <p className='text-gray-600 dark:text-gray-300 mb-6'>
              This overlay contains custom content while
              still applying the blur effect to the
              background.
            </p>
            <button
