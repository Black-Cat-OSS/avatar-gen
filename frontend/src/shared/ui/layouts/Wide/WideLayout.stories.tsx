  ...
  <div className='py-8'>
    <div className='mb-8'>
      ...
      <p className='text-gray-600 dark:text-gray-300'>
        Wide layout is perfect for dashboards and data
        visualization
      </p>
    </div>
...
export const Dashboard: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Wide layout perfect for analytics dashboards with multiple charts and data tables.',
      },
    },
  },
}
    ...
    <WideLayoutStorybook>
      <div className='py-8'>
        <div className='mb-6'>
          ...
          <p className='text-gray-600 dark:text-gray-300'>
            Wide table with many columns showcases the
            layout's full-width advantage
          </p>
        </div>
        <div className='bg-white dark:bg-gray-800 shadow rounded-lg border border-gray-200 dark:border-gray-700'>
          <div className='overflow-x-auto'>
...
export const GridGallery: Story = {
      ...
      <div className='py-8'>
        <div className='mb-8 text-center'>
          ...
          <p className='text-gray-600 dark:text-gray-300 max-w-2xl mx-auto'>
            Wide layout allows for more images per row,
            creating a better gallery experience
          </p>
        </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Grid gallery that takes advantage of the wide layout to show more items per row.',
      },
    },
  },
}
...
export const ComparisonWithDefault: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Visual comparison between Wide and Default layouts to show the width difference.',
      },
    },
  },
}
...
export const WithCustomStyling: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Wide layout with custom gradient background styling.',
      },
    },
  },
}
