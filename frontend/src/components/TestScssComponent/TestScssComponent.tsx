...
export const TestScssComponent: React.FC = () => {
  return (
    <div className={styles.container}>
      <h1 className={`${styles.container__header} ${styles['container__header--large']}`}>
        SCSS Module Test
      </h1>
      <div className={`${styles.container__content} ${styles['container__content--centered']}`}>
        <p>This component uses SCSS modules with TypeScript support!</p>
