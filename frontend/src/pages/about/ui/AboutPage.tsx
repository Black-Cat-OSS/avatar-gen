...
const getTechLogo = (techName: string) => {
  if (techName.toLowerCase().includes('react'))
    return '/dev-stack/React.svg'
  if (techName.toLowerCase().includes('vite'))
    return '/dev-stack/Vite.js.svg'
  if (techName.toLowerCase().includes('typescript'))
    return '/dev-stack/TypeScript.svg'
  if (techName.toLowerCase().includes('tailwind'))
    return '/dev-stack/Tailwind CSS.svg'
  if (techName.toLowerCase().includes('router'))
    return '/dev-stack/TypeScript.svg'
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-8'>
          <div className='bg-card p-6 rounded-lg border border-border'>
            ...
            <p className='text-muted-foreground'>
              {t('pages.about.fsdArchitecture.description')}
            </p>
          </div>
          ...
          <div className='bg-card p-6 rounded-lg border border-border'>
            ...
            <p className='text-muted-foreground'>
              {t('pages.about.themeSystem.description')}
            </p>
          </div>
        </div>

        <Callout
          title={t('pages.about.technologyStack.title')}
          type='info'
          className='mb-4'
        >
