    ...
    <div className='py-8'>
      <div className='text-center mb-8'>
        <h1 className='text-4xl font-bold text-foreground mb-4'>
          {t('pages.devStack.title')}
        </h1>
        <p className='text-muted-foreground text-lg'>
          {t('pages.devStack.subtitle')}
        </p>
      </div>
      ...
      <Callout
        ...
        subtitle={t(
          'pages.devStack.architecture.description',
        )}
        type='info'
        className='mb-8'
      >
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
          <div className='bg-white dark:bg-gray-900 p-4 rounded border border-blue-200 dark:border-blue-800'>
            <h3 className='font-semibold text-blue-600 dark:text-blue-400 mb-2'>
              {t(
                'pages.devStack.architecture.frontend.title',
              )}
            </h3>
            <p className='text-blue-700 dark:text-blue-300 text-sm'>
              {t(
                'pages.devStack.architecture.frontend.description',
              )}
            </p>
          </div>
          <div className='bg-white dark:bg-gray-900 p-4 rounded border border-blue-200 dark:border-blue-800'>
            <h3 className='font-semibold text-blue-600 dark:text-blue-400 mb-2'>
              {t(
                'pages.devStack.architecture.backend.title',
              )}
            </h3>
            <p className='text-blue-700 dark:text-blue-300 text-sm'>
              {t(
                'pages.devStack.architecture.backend.description',
              )}
            </p>
          </div>
        </div>
